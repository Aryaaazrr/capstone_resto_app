                    ...
                    <div class="row" data-aos="fade-up" data-aos-delay="100">
                        <div class="col-lg-12 d-flex justify-content-center">
                            <ul id="menu-flters">
                                ...
                                <li data-filter=".filter-starters">Paket Ijen</li>
                                <li data-filter=".filter-salads">Paket Kembul</li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 d-flex justify-content-center">
                                    <div data-aos="zoom-in" data-aos-delay="100">
                                        <h3 class="text-center">Paket Ijen</h3>
                                        <div class="col">
                                            @foreach ($product as $item)
                                                <div class="form-group d-flex justify-content-between">
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-control-sm bl-4" type="number" min="10"
                                                            name="qty_{{ $item->id_product }}" placeholder="10">
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                ...
                                <div class="col-md-6 d-flex justify-content-center">
                                    <div data-aos="zoom-in" data-aos-delay="100">
                                        <h3 class="text-center">Paket Kembul</h3>
                                        <div class="col">
                                            <div class="form-group d-flex justify-content-between">
                                                <div class="form-check">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 form-group">
                                    <input type="text" name="name" class="form-control" id="name"
                                        ...
                                        data-msg="Silakan masukkan setidaknya 4 karakter">
